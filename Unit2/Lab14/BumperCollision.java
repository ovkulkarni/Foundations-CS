   ...
   {
      private static int nearestX;	// used to approximate what point of the bumper  
      private static int nearestY;  // a ball collided with
       ...
       public static void collide(Bumper bumper, Ball ball)
      {
         ...
         {	   	
            ...
            ux/=ur;
            uy/=ur;
            double dx=(int)ball.getdx();
            double dy=(int)ball.getdy();
